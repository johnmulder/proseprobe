...
|--------|----------|-------|-------------|
| `V` | Vocabulary | 13 | Overused and clichéd words and phrases |
...
`M002`-`M010` and `S025` are Markdown-only.
...
| `technical-docs` | General plus C001-C004, G017, G024, G029, M001-M010, S025, T015, V009-V011, V013, and V016 | info | low |
