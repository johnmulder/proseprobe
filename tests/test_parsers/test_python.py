...
from proseprobe.parsers.python import (
    Comment,
    Docstring,
    PythonParser,
    _get_cached_parser,
...
'''
    ...
    def test_extract_python_inline_suppressions_from_comment_tokens(self) -> None:
        ...
        content = (
            '"""Delve here."""  # proseprobe: ignore=v001, S010\n'
            "# Delve here.  # proseprobe: ignore=V001\n"
        )
    ...
    def test_python_suppression_markers_in_strings_are_ignored(self) -> None:
        ...
        content = (
            'message = "# proseprobe: ignore=V001"\n"""# proseprobe: ignore=S010"""\n'
        )
    ...
    def test_malformed_python_suppression_reports_source_line(self) -> None:
        ...
        parser = PythonParser("x = 1  # proseprobe: ignored=V001\n")
